...
label start_schoolgirl:
 ...
 show sg side hands_down_scarf closed sad smile at center with d
 sf " Как тут тихо. И вокруг никого никого. "
 show sg front hands_down open angry smile at center with d
 sg "А как же полицейские на дороге?"
 show sf front hands_down open sad happy at right with d
 sf " Ну… Они там были, а тут вообще никого. "
 pause 1.6
 show sf side hands_up open angry frown at left with d
